...
('Vaqueros Slim Fit', 'Unos vaqueros muy ajustados', 9, 1,'42','Azul'),('Vaqueros de campana', 'Vaqueros antiguos', 9, 1,'42','Azul'),
('Vaqueros Rotos', 'Unos vaqueros rotos', 6, 1,'36','Negro'),('Air Force One', 'Unas zapatillas para combinar', 1, 2,'40','Blanco'),
('Sudera PSG', 'Una sudadera de fútbol', 1, 7,'L','Granate'),('Zapatos de punta', 'Unos zapatos que combinan con todo', 9, 10,'44','Nergo'),
('Jersey abrigado', 'Un jersey para invierno', 8, 8,'XL','Azul'),('Camiseta Real Betis', 'Una camiseta del Real Betis', 2, 3,'XXL','Verde'),
('Boxer CK', 'Calsonzillos para hombre Calvin Klein', 4, 5,'XS','Negro'),('Bragas con agujeros', 'Unas bragas con agujeros', 7, 5,'XS','Blanco'),
('Playeras', 'Sandalias comodas para la playa', 1, 9,'42','Amarillo'),('Camisa ajustada', 'Una camisa ajustada para usar con traje', 9, 4,'L','Blanco'),
('Camiseta ancha', 'Una camiseta ancha de uso diario', 3, 3,'XL','Negro'),('Jordan Airmax', 'Botines deportivos', 1, 2,'4','Rojo'),
('Bambas', 'Zapatillas de uso diario', 10, 2,'43','Rojo'),('Vaqueros anchos', 'Unos vaqueros anchos unisex', 6, 1,'42','Negro'),
('Calcetines tobilleros', 'Calcetines cortos de tobillo', 4, 6,'40/42','Negro'),('Camiseta del Sevilla FC', 'Una camiseta del equipo Sevilla FC', 10, 3,'XL','Rojo'),

('Calcetines largos', 'Unos calcetines largos para invierno', 7, 6,'44','Negro'),
('Calzoncillos cortos', 'Calzoncillos boxers cortos tradicionales', 4, 5,'XS','Blanco'),('Chándal PSG', 'Pantalón de chándal del equipo PSG', 1, 7,'XL','Granate'),
('Zapatos de feria', 'Unos zapatos arreglados para trajes de feria', 9, 10,'45','Marrón'), ('Zancos', 'Unos botines sin talon de uso diario', 1, 2,'42','Rojo'),
('Calzonas ajustadas', 'Unas calzonas ajustadas deportivas', 10, 7,'XXL','Azul'),('Calzona bañador', 'Calzonas que sirven de bañador ', 2, 7,'XS','Azul'),
('Vaqueros fly', 'Unos vaqueros largos rotos', 6, 1,'42','Azul'),
('Camisa ancha', 'Una camisa ancha muy facil de combinar', 3, 4,'L','Blanco'),
('Total 90', 'Unos botines para jugar a futbol 11', 1, 2,'44','Rojiblanco'),
('Botines multitacos', 'Unos botines para validos para fútbol 11 y fútbol sala', 10, 2,'46','Rojo'),('Botines lisos', 'Unos botines para jugar a fútbol sala', 2, 2,'40','Azul'),
('Calcetines arreglados', 'Calcetines largos para traje', 1, 6,'38','Negro'), ('Calzoncillo tradicional', 'Calzoncillos boxers adicionales', 1, 5,'XS','Negro'),
('Tangas', 'Bragas de mujer estilo brasileiro', 4, 5,'XS','Rojo'),('Pantalon tela gruesa', 'Un pantalon muy calido y cómodo', 8, 1,'42','Marrón'),
('Pantalon tela gruesa', 'Un pantalon muy calido y cómodo', 8, 1,'36','Marrón');
